...
function Intro(){
    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6">
          <img className="d-block mx-auto mb-4 rounded" src="./assets/Screenshot_20230104_080433_Bumble.jpg" alt="" width="400" height="500" />
        </div>
    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6">
          <img className="d-block mx-auto mb-4 rounded" src="./assets/tools.png" alt="" width="500" height="500" />
        </div>
        <div className="col-lg-6">
    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6">
          <img className="d-block mx-auto mb-4 rounded" src="./assets/BlockchainTools.png" alt="" width="500" height="500" />
        </div>
        <div className="col-lg-6">
